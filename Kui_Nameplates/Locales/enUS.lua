...
L["Health bar text offset"] = true
L["Vertical offset of the text on the top and bottom of the health bar: level, name and health.\nNote that the default value ends in .5 as this prevents jittering text."] = true
